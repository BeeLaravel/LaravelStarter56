...
class NoteController extends Controller {
        ...
        if ( $request->ajax() ) {
            ...
            if ( $model ) {
                foreach ( $model as $item ) {
                    $item->title = '<a href="' . url($this->baseInfo['link']."/renew/".$item->id) . '">' . $item->title . '</a>';
    ...
    public function renew(int $id) {
        ...
        return view($this->baseInfo['view_path'].'renew', array_merge($this->baseInfo, compact('types', 'tags', 'item')));
    }
