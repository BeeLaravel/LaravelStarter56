...
class PostController extends Controller
{
        ...
        if ( $request->ajax() ) {
            ...
            if ( $model ) {
                foreach ( $model as $item ) {
                    ...
                    $item->button = $item->getActionButtons('post');
                }
            }
            ...
            return view('admin.post.post.index', compact('search', 'types', 'tags'));
        }
    }
    public function create()
    {
        ...
        return view('admin.post.post.create', compact('types', 'tags', 'keywords'));
    }
