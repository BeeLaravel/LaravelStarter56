...
class PostTagController extends Controller
{
        ...
        if ( $request->ajax() ) {
            ...
            if ( $model ) {
                foreach ( $model as $item ) {
                    ...
                    $item->button = $item->getActionButtons('posttag');
                }
            }
            ...
            return view('admin.post.tag.index', compact('search', 'tags'));
        }
    }
    public function create()
    {
        ...
        return view('admin.post.tag.create', compact('tags'));
    }
    public function store(Request $request)
    {
        ...
        if ( $result ) {
            ...
            return redirect('/admin/posttag'); // 列表
        } else {
            flash('操作失败', 'error');
    ...
    public function edit(int $id)
    {
        ...
        return view('admin.post.tag.edit', compact('tags', 'tag'));
    }
