...
use App\Http\Requests\User\PictureRequest;
...
class PictureController extends Controller {
    ...
    public function index(Request $request) {
        if ( $request->ajax() ) {
            ...
            return view('admin.user.picture.index', compact('types', 'search'));
        }
    }
    public function create(Request $request) {
        ...
        return view('admin.user.picture.create', compact('types', 'categories', 'tags'));
    }
    public function store(PictureRequest $request) {
        ...
        if ( $result ) {
            ...
            return redirect('/admin/pictures'); // 列表
        } else {
            flash('操作失败', 'error');
    ...
    public function edit(int $id) {
        ...
        return view('admin.user.picture.edit', compact('types', 'categories', 'tags', 'item'));
    }
