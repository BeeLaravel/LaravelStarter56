...
@section('content')
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">修改头修</li>
    </ol>
    <h1 class="page-header">修改头修 <small>修改我的头像</small></h1>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group"><!-- 头像 -->
                            <label class="control-label col-md-4 col-sm-4" for="avatar">头像 * :</label>
                            <div class="col-md-6 col-sm-6">
                                <input class="form-control" type="text" name="avatar" value="{{ $item['avatar'] }}" placeholder="头像" data-parsley-required="true" id="avatar" />
                            </div>
                        </div>
