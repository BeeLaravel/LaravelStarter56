...
@section('content')
    <ol class="breadcrumb pull-right">
        ...
        <li><a href="{{url('/admin/pictures')}}">图片</a></li>
        <li class="active">新增</li>
    </ol>
    <h1 class="page-header">图片 <small>用户图片</small></h1>
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered" action="{{ url('/admin/pictures') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group"><!-- 链接 -->
                            ...
                            <div class="col-md-6 col-sm-6">
                                <input class="form-control" type="file" name="image" value="{{ old('image') }}" placeholder="图片" data-parsley-required="true" id="image" />
                            </div>
                        </div>
