        ...
        <div class="col-md-12">
            <div class="panel panel-inverse" data-sortable-id="table-basic-5">
                ...
                <div class="panel-body">
                    <a href="{{ url('admin/pictures/create') }}" class="pull-right">
                        <button type="button" class="btn btn-primary m-r-5 m-b-5"><i class="fa fa-plus-square-o"></i> 添加图片</button>
                    </a>
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{ asset('statics/admin/scripts/user/picture.js') }}"></script>
