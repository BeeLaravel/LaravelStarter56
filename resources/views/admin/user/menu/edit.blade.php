...
@section('content')
    <ol class="breadcrumb pull-right">
        ...
        <li><a href="{{url('/admin/menus')}}">菜单</a></li>
        <li class="active">编辑</li>
    </ol>
    <h1 class="page-header">菜单 <small>用户菜单</small></h1>
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered" action="{{ url('/admin/menus/'.$item['id']) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PATCH') }}
