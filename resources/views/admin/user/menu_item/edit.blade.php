...
@section('content')
    <ol class="breadcrumb pull-right">
        ...
        <li><a href="{{url('/admin/menus')}}">菜单项</a></li>
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered" action="{{ url('/admin/menu_items/'.$item['id']) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PATCH') }}
