...
@section('styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('/plugins/jquery/treeTable/vsStyle/jquery.treeTable.css')}}">
@endsection
...
@section('content')
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">菜单项</li>
    </ol>
    <h1 class="page-header">菜单项 <small>用户菜单项</small></h1>
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse" data-sortable-id="table-basic-5">
                ...
                <div class="panel-body">
                    <a href="{{ url('admin/menu_items/create/'.$menu_id) }}" class="pull-right">
...
@section('scripts')
    ...
    <script src="{{ asset('plugins/jquery/treeTable/jquery.treeTable.js') }}"></script>
