...
@section('content')
    ...
    <h1 class="page-header">页面 <small>用户页面</small></h1>
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse" data-sortable-id="table-basic-5">
                ...
                <div class="panel-body">
                    {{--@if ( auth('admin')->user()->can('pages.add') )--}}
                        <a href="{{ url('admin/pages/create') }}" class="pull-right">
                            <button type="button" class="btn btn-primary m-r-5 m-b-5"><i class="fa fa-plus-square-o"></i> 添加页面</button>
                        </a>
                    {{--@endif--}}
...
@section('script')
    ...
    <script type="text/javascript" src="{{ asset('admin/js/user/page.js') }}"></script>
