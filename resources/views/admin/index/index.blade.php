...
@section('stylesheet')
    ...
    <link href="{{asset('template/color_admin/plugins/bootstrap-datepicker/css/datepicker3.css')}}" rel="stylesheet" />
    <link href="{{asset('template/color_admin/plugins/gritter/css/jquery.gritter.css')}}" rel="stylesheet" />
...
@section('content')
    ...
    <h1 class="page-header">仪表盘 <small>一图洞悉天下事</small></h1>
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="panel panel-inverse" data-sortable-id="index-1">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">网站分析 (过去 7 天)</h4>
                </div>
            ...
            <ul class="nav nav-tabs nav-tabs-inverse nav-justified nav-justified-mobile" data-sortable-id="index-2">
                ...
                <li class=""><a href="#email" data-toggle="tab"><i class="fa fa-envelope m-r-5"></i> <span class="hidden-xs">邮件</span></a></li>
            </ul>
                        ...
                        <ul class="media-list media-list-with-divider">
                            <li class="media media-lg">
                                <a href="javascript:;" class="pull-left">
                                    <img class="media-object" src="{{asset('template/color_admin/img/gallery/gallery-1.jpg')}}" alt="" />
                                </a>
                            ...
                            <li class="media media-lg">
                                <a href="javascript:;" class="pull-left">
                                    <img class="media-object" src="{{asset('template/color_admin/img/gallery/gallery-10.jpg')}}" alt="" />
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media media-lg">
                                <a href="javascript:;" class="pull-left">
                                    <img class="media-object" src="{{asset('template/color_admin/img/gallery/gallery-7.jpg')}}" alt="" />
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media media-lg">
                                <a href="javascript:;" class="pull-left">
                                    <img class="media-object" src="{{asset('template/color_admin/img/gallery/gallery-8.jpg')}}" alt="" />
                                </a>
                                <div class="media-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="hidden-sm">
                                        <a href="javascript:;">
                                            <img src="{{asset('template/color_admin/img/product/product-1.png')}}" alt=""  />
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="hidden-sm">
                                        <a href="javascript:;">
                                            <img src="{{asset('template/color_admin/img/product/product-2.png')}}" alt="" />
                                        </a>
                                    </td>
                                    <td>
                                        <h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, eget faucibus nibh placerat.</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td class="hidden-sm">
                                        <a href="javascript:;">
                                            <img src="{{asset('template/color_admin/img/product/product-3.png')}}" alt="" />
                                        </a>
                                    </td>
                                    <td>
                                        <h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, eget faucibus nibh placerat.</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td class="hidden-sm">
                                        <a href="javascript:;">
                                            <img src="{{asset('template/color_admin/img/product/product-4.png')}}" alt="" />
                                        </a>
                                    </td>
                                    <td>
                                        <h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, eget faucibus nibh placerat.</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td class="hidden-tablet hidden-phone">
                                        <a href="javascript:;">
                                            <img src="{{asset('template/color_admin/img/product/product-5.png')}}" alt="" />
                                        </a>
                                    </td>
                                    <td>
                                        <h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, eget faucibus nibh placerat.</a></h6>
                    ...
                    <div class="height-sm" data-scrollbar="true">
                        <ul class="media-list media-list-with-divider">
                            <li class="media media-sm">
                                <a href="javascript:;" class="pull-left">
                                    <img src="{{asset('template/color_admin/img/user-1.jpg')}}" alt="" class="media-object rounded-corner" />
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media media-sm">
                                <a href="javascript:;" class="pull-left">
                                    <img src="{{asset('template/color_admin/img/user-2.jpg')}}" alt="" class="media-object rounded-corner" />
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media media-sm">
                                <a href="javascript:;" class="pull-left">
                                    <img src="{{asset('template/color_admin/img/user-3.jpg')}}" alt="" class="media-object rounded-corner" />
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media media-sm">
                                <a href="javascript:;" class="pull-left">
                                    <img src="{{asset('template/color_admin/img/user-4.jpg')}}" alt="" class="media-object rounded-corner" />
                                </a>
                                <div class="media-body">
            ...
            <div class="panel panel-inverse" data-sortable-id="index-4">
                ...
                <textarea class="form-control no-rounded-corner bg-silver" rows="14">请输入</textarea>
                <div class="panel-footer text-right">
                    <a href="javascript:;" class="btn btn-white btn-sm">取消</a>
                ...
                <div class="panel-body">
                    <div class="height-sm" data-scrollbar="true">
                        <ul class="media-list media-list-with-divider media-messaging">
                            <li class="media media-sm">
                                <a href="javascript:;" class="pull-left">
                                    <img src="{{asset('template/color_admin/img/user-5.jpg')}}" alt="" class="media-object rounded-corner" />
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media media-sm">
                                <a href="javascript:;" class="pull-left">
                                    <img src="{{asset('template/color_admin/img/user-6.jpg')}}" alt="" class="media-object rounded-corner" />
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media media-sm">
                                <a href="javascript:;" class="pull-left">
                                    <img src="{{asset('template/color_admin/img/user-8.jpg')}}" alt="" class="media-object rounded-corner" />
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media media-sm">
                                <a href="javascript:;" class="pull-left">
                                    <img src="{{asset('template/color_admin/img/user-7.jpg')}}" alt="" class="media-object rounded-corner" />
                                </a>
                                <div class="media-body">
                                    <h5 class="media-heading">John Doe</h5>
                ...
                <div class="panel-footer">
                    <form>
                        <div class="input-group">
                            <input type="text" class="form-control bg-silver" placeholder="输入消息" />
            ...
            <div class="panel panel-inverse" data-sortable-id="index-6">
                ...
                <div class="panel-body p-t-0">
                    <table class="table table-valign-middle m-b-0">
                        ...
                        <tbody>
                            <tr>
                                <td><label class="label label-danger">净访客数</label></td>
                                <td>13,203 <span class="text-success"><i class="fa fa-arrow-up"></i></span></td>
                                <td><div id="sparkline-unique-visitor"></div></td>
                            </tr>
                            <tr>
                                <td><label class="label label-warning">跳出率</label></td>
                                <td>28.2%</td>
                                <td><div id="sparkline-bounce-rate"></div></td>
                            </tr>
                            <tr>
                                <td><label class="label label-success">PV</label></td>
                                <td>1,230,030</td>
                            ...
                            <tr>
                                <td><label class="label label-inverse">回访访客</label></td>
                                <td>73.4%</td>
...
@section('script')
    ...
    <script src="{{asset('template/color_admin/plugins/flot/jquery.flot.time.min.js')}}"></script>
    <script src="{{asset('template/color_admin/plugins/flot/jquery.flot.resize.min.js')}}"></script>
    <script src="{{asset('template/color_admin/plugins/flot/jquery.flot.pie.min.js')}}"></script>
    <script src="{{asset('template/color_admin/plugins/sparkline/jquery.sparkline.js')}}"></script>
    <script src="{{asset('template/color_admin/plugins/jquery-jvectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
    <script src="{{asset('template/color_admin/plugins/jquery-jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
    <script src="{{asset('template/color_admin/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js')}}"></script>
    <script src="{{asset('template/color_admin/js/dashboard.min.js')}}"></script>
