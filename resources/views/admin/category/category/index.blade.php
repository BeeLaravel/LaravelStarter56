        ...
        <div class="col-md-12">
            <div class="panel panel-inverse" data-sortable-id="table-basic-5">
                ...
                <div class="panel-body">
                    <a href="{{ url($link.'/create'.'?'.http_build_query(['parent_id' => $search['parent_id']])) }}" class="pull-right">
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{ asset('statics/admin/scripts/category/category.js') }}"></script>
